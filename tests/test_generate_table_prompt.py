...
client = Client(project_id=PROJECT_ID,model_location= MODEL_LOCATION,dataplex_location=DATAPLEX_LOCATION, dataset_location=DATASET_LOCATION, client_options=client_options)
...
client.generate_column_descriptions(table_fqn)
